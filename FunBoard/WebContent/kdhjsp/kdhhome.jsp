...
<body>
	<nav class="navbar navbar-expand navbar-dark bg-dark" id="navbarsExample02">
		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav mr-auto">
				<c:if test="${not empty login}">
					<li class="nav-item active"><a class="nav-link" href="logout.kdh">로그아웃</a></li>
				</c:if>
				<c:if test="${empty login}">
					<li class="nav-item active"><a class="nav-link" href="loginui.kdh">로그인</a></li>
				</c:if>
			...
			<a class="btn btn-outline-primary" href="#">검색</a>
		</div>
	</nav>
	...
	<div class="jumbotron">
		...
		<c:if test="${not empty login}">
			<h1 class="display-4">${login.id}님 환영합니다.</h1>
		</c:if>
		<c:if test="${empty login}">
		...
		<br><br><br><br>
		<br> <a href="home.main">모두의 메인으로</a>
	</div>
</body>
</html>