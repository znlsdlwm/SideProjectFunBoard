...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<div class="jumbotron">
	<a class="btn btn-info btn-lg" role="button" href="readboard.kdh?num=${num}">돌아가기</a>
	</div>
	<c:if test="${not empty alertresult}">
		<script type="text/javascript">alert('${alertresult}')</script>
	</c:if>
</body>
</html>